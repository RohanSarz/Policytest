 ...
 * @see app/Http/Controllers/PostController.php:22
 * @route '/posts'
 */
 ...
 * @see app/Http/Controllers/PostController.php:87
 * @route '/posts/create'
 */
 ...
 * @see app/Http/Controllers/PostController.php:95
 * @route '/posts'
 */
 ...
 * @see app/Http/Controllers/PostController.php:143
 * @route '/posts/{post}'
 */
 ...
 * @see app/Http/Controllers/PostController.php:160
 ...
 * @see app/Http/Controllers/PostController.php:176
 * @route '/posts/{post}'
 */
 ...
 * @see app/Http/Controllers/PostController.php:227
 * @route '/posts/{post}'
 */
...
/**
* @see \App\Http\Controllers\PostController::byCategory
...
const PostController = { index, create, store, show, edit, update, destroy, byCategory }
