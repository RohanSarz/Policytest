      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
        ...
        <div class="lg:col-span-2">
          ...
          <p class="text-gray-400 mb-4">
            ...
            accuracy, and journalistic excellence.
          </p>
      ...
      <div class="border-t border-gray-800 mt-8 pt-8">
          ...
          <div class="text-gray-400">
            ...
            <div class="flex">
              <input
                ...
                class="px-3 py-1 text-gray-900 rounded-l text-sm w-full"
              />
              <button
                class="bg-red-600 hover:bg-red-700 px-3 py-1 rounded-r text-sm"
              >
                →
              </button>
            </div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex space-x-6 text-sm text-gray-500">
            <a
              href="#"
              class="hover:text-gray-300 hover:underline transition-colors"
            >Terms of Use</a>
            <a
              href="#"
              class="hover:text-gray-300 hover:underline transition-colors"
