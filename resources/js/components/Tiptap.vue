  ...
  <div class="tiptap-editor">
    <div class="toolbar mb-2 flex flex-wrap gap-2">
      ...
      <button
        ...
        :class="{ 'bg-blue-500 text-white': currentImageAlignment === 'left' }"
        class="px-3 py-1 bg-gray-200 rounded hover:bg-gray-300 text-sm"
        type="button"
      ...
      <button
        @click="editor?.chain().focus().setImageAlignment('center').run()"
        :class="{ 'bg-blue-500 text-white': currentImageAlignment === 'center' }"
        class="px-3 py-1 bg-gray-200 rounded hover:bg-gray-300 text-sm"
        type="button"
        :disabled="!imageSelected"
        title="Center Image"
      ...
      <button
        @click="editor?.chain().focus().setImageAlignment('right').run()"
        :class="{ 'bg-blue-500 text-white': currentImageAlignment === 'right' }"
        class="px-3 py-1 bg-gray-200 rounded hover:bg-gray-300 text-sm"
        type="button"
        :disabled="!imageSelected"
        title="Float Right"
...
/* Make sure the editor content looks good */
